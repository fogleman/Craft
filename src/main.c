...
int main(int argc, char **argv) {
    ...
    load_png_texture("textures/texture0.png", 0);
    load_png_texture("textures/texture1.png", 1);
    load_png_texture("textures/texture2.png", 2);
    load_png_texture("textures/texture3.png", 3);
    load_png_texture("textures/texture4.png", 4);
    ...
    load_png_texture("textures/font.png", 0);
    ...
    load_png_texture("textures/sky.png", 0);
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    load_png_texture("textures/sign.png", 0);
